    ...
    return (
        ...
        <div className='jobCard bg-[#ffffff] rounded-3xl lg:w-10.93% lg:h-8.44% flex drop-shadow-lg  mt-5 mb-6 justify-center ml-30 mr-30  'style={{width:"70vw"}}>
           ...
           <div style={{paddingRight:'10%'}}>
            ...
            <h3 className='  font-Poppins  text-stone-600 lg:text-[10px] md:text-[6px] sm:text-3px text-sm font-semibold  'style={{margin:'0'}}>{props.companyName}</h3>
            <h3 className='font-Poppins text-stone-600 lg:text-2xl md:text-xl  font-semibold' style={{margin:'0',width:'20vw'}}> {props.jobTitle} ({props.experience} year(s))</h3>
            ...
            <Image  className='flex  justify-center align-bottom'
              ...
              height='0.5vw'
            />
            <h3 className='font-Poppins  text-stone-600 lg:text-[10px] md:text-[8px] text-base-sm font-semibold justify-center 'style={{margin:'0'}}>{props.location}</h3>
            ...
            <div  style={{marginRight:"-10%",margin:"3%", width:'30vw',paddingLeft:'20%',alignItems:'center', alignContent:'center', display:'flex',}} >
            <button className=' text-center   wrap-flex   text-white   w-4/5 sm:w-1/3 md:w-1/2 lg:w-2/4 h-13 sm:h-10 lg:h-16 bg-sky-800 'style={{borderRadius:'50px'}} onClick={viewDetails}>view Details</button>
            </div>
            </div>  
            </div>
