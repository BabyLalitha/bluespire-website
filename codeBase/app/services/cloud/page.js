...
<center><div style={{ backdropFilter: "blur(424px)", justifyContent: 'center', alignItems: 'center', display: 'inline-flex' }}>
      ...
      <div className='my-16'>
          ...
          <div className='h-full md:w-1/2 w-[100%] flex justify-center items-center'>
            <div className='md:w-[40vw] w-[90%]'>
              ...
              <p className='text-md font-light'>
                ...
                Enterprises are embracing the advanced cloud technology to accelerate their business growth in a rapid pace to keep up with the constantly evolving business needs and the ever changing customer demands.
                ...
                On-premise business application to cloud migration
                Re-architect & Modernization of existing applications for cloud deployments
                Data migration and Cross platform migration (e.g Azure to AWS or other platforms)
                DevOps & Automation on Cloud
              </p>
        ...
        <div style={{ background: '#F5F5F5' }}>
          ...
          <div >
            <div style={{ color: 'black', paddingBottom: '44px', fontSize: '24px', fontWeight: '700', textAlign: 'center' }}>Cloud Migration Services<br /></div>
            ...
            <div style={{ color: '#000000', fontSize: '18px', fontWeight: '400', lineHeight: '30px', alignContent: 'center', lineHeight: '30px', wordWrap: 'break-word' }}>
              <div style={{ padding: '0 5%' }}> We provides a full array of cloud migration services that helps you leverage the cloud platform to its full potential. We perform an in depth analysis of your existing business, requirements, future plans and goals, while enabling you to understand your cloud readiness level and determine an actionable technology roadmap to leverages the power of cloud. Our experienced team will work with you to gain an understanding of your business process, existing IT infrastructure & technologies to design a strategy through:

                What to Move: Prioritize your applications, workflows and infrastructure for cloud migrations.
                How to Move: Formulate a migration strategy to address your business goals and migrate your processes with minimal disruption to your business operations.
                Where to Move: We help you migrate to reliable platforms like Microsoft Azure, Amazon Web Services (AWS) and more.
                Cloud Infrastructure Design: We work towards meeting your organization’s requirements by defining & creating cloud infrastructure that is reliable, secure, scalable and easy to maintain.
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#F5F5F5' }}>
          <div >
            <div style={{ color: 'black', paddingBottom: '44px', fontSize: '24px', fontWeight: '700', textAlign: 'center' }}>Cloud Managed Services & Automation<br /></div>

            <div style={{ color: '#000000', fontSize: '18px', fontWeight: '400', lineHeight: '30px', alignContent: 'center', lineHeight: '30px', wordWrap: 'break-word' }}>
              <div style={{ padding: '0 5%' }}> Cloud infrastructure management is a time consuming activity. You focus on your core business and leave your cloud management to our cloud experts. We provide round the clock cloud management services which covers complete cloud infrastructure management, cloud monitoring, cloud usage optimization, DevOps, cloud automation and much more. We continuously monitor to traffic spikes, possible problems, identify threats and manage incidents 24/7. Our cloud consultants can analyze your existing cloud infrastructure setup to identify gaps and offer solutions to address them for improvements.
