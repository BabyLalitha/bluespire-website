    ...
    <div className='font-poppins'>
      ...
      <div className='my-16'>
        ...
        <center><div>
          ...
          <div >
            <div className="flex flex-wrap " style={{ margin: '40px 15% 40px' }}>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={one} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={two} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={three} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={four} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={five} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={six} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={seven} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>

              <div className="w-1/2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 p-2">
                <Image
                  src={ten} alt="Image 1" className="w-[173px] h-[76px] rounded-lg" />
              </div>
